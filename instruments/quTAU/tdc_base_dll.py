...
def _load_dll():
    """Attempt to load tdcbase.dll. Returns the DLL object or None if not found."""
    base_path = "C:\\Users\\LabUser\\Documents\\cold-control\\dlls"
    dll_path = Path(base_path) / r"quTAU\userlib\lib64\tdcbase.dll"
    try:
        return windll.LoadLibrary(str(dll_path))
    except (OSError, FileNotFoundError):
        return None


def _make_stub(name, default_return: Any = 0):
    """Return a callable that logs the call and returns a default value (DLL not available)."""

    def stub(*args, **kwargs):
        _log.info(
            "[TdcBaseDll STUB] %s called with args=%s kwargs=%s (DLL not loaded)",
            name,
            args,
            kwargs,
        )
...
class TdcBaseDll:
    ...
    if _dll is not None:
        ...
        get_timebase = tdc_base_dll.TDC_getTimebase
        get_timebase.restype = c_double
        ...
        de_initialise = tdc_base_dll.TDC_deInit
        de_initialise.restype = None
        de_initialise.argtypes = ()
        ...
        get_device_params = tdc_base_dll.TDC_getDeviceParams
        get_device_params.restype = c_int
        get_device_params.argtypes = (POINTER(c_int32), POINTER(c_int32), POINTER(c_int32))
        ...
        check_for_hbt_feature = tdc_base_dll.TDC_checkFeatureHbt
        check_for_hbt_feature.restype = c_int
        check_for_hbt_feature.argtypes = ()
        ...
        check_for_lifetime_feature = tdc_base_dll.TDC_checkFeatureLifeTime
        check_for_lifetime_feature.restype = c_int
        check_for_lifetime_feature.argtypes = ()
        ...
        configure_apd_cooling = tdc_base_dll.TDC_configureApdCooling
        configure_apd_cooling.restype = c_int
        configure_apd_cooling.argtypes = (c_int32, c_int32)
        ...
        configure_internal_apds = tdc_base_dll.TDC_configureInternalApds
        configure_internal_apds.restype = c_int
        configure_internal_apds.argtypes = (c_int32, c_double, c_double)
        ...
        configure_self_test = tdc_base_dll.TDC_configureSelftest
        configure_self_test.restype = c_int
        configure_self_test.argtypes = (c_int32, c_int32, c_int32, c_int32)
        ...
        configure_sync_divider = tdc_base_dll.TDC_configureSyncDivider
        configure_sync_divider.restype = c_int
        configure_sync_divider.argtypes = (c_int32, c_int32)
        ...
        enable_channels = tdc_base_dll.TDC_enableChannels
        enable_channels.restype = c_int
        enable_channels.argtypes = (c_int,)
        ...
        enable_tdc_input = tdc_base_dll.TDC_enableTdcInput
        enable_tdc_input.restype = c_int
        enable_tdc_input.argtypes = (c_int32,)
        ...
        freeze_buffers = tdc_base_dll.TDC_freezeBuffers
        freeze_buffers.restype = c_int
        freeze_buffers.argtypes = (c_int32,)
        ...
        #                                           Int32     count
        # )    ;///<Generate Timestamps.
        generate_timestamps = tdc_base_dll.TDC_generateTimestamps
        generate_timestamps.restype = c_int
        # TODO: enum
        generate_timestamps.argtypes = (c_int, POINTER(c_double), c_int32)
        ...
        get_channel_delays = tdc_base_dll.TDC_getChannelDelays
        get_channel_delays.restype = c_int
        get_channel_delays.argtypes = (POINTER(c_int32),)
        ...
        get_coincidence_counters = tdc_base_dll.TDC_getCoincCounters
        get_coincidence_counters.restype = None
        get_coincidence_counters.argtypes = (POINTER(c_int32), POINTER(c_int32))
        ...
        check_data_loss = tdc_base_dll.TDC_getDataLost
        check_data_loss.restype = c_int
        check_data_loss.argtypes = (POINTER(c_int32),)
        ...
        get_dev_type = tdc_base_dll.TDC_getDevType
        get_dev_type.restype = c_int
        ...
        get_last_timestamps = tdc_base_dll.TDC_getLastTimestamps
        get_last_timestamps.restype = None
        ...
        get_signal_conditioning = tdc_base_dll.TDC_getSignalConditioning
        get_signal_conditioning.restype = c_int
        ...
        get_sync_divider = tdc_base_dll.TDC_getSyncDivider
        get_sync_divider.restype = c_int
        get_sync_divider.argtypes = (POINTER(c_int32), POINTER(c_int32))
        ...
        get_timestamp_buffer_size = tdc_base_dll.TDC_getTimestampBufferSize
        get_timestamp_buffer_size.restype = c_int
        get_timestamp_buffer_size.argtypes = (POINTER(c_int32),)
        ...
        get_version = tdc_base_dll.TDC_getVersion
        get_version.restype = c_double
        ...
        input_timestamps = tdc_base_dll.TDC_inputTimestamps
        input_timestamps.restype = c_int
        input_timestamps.argtypes = (POINTER(c_int64), POINTER(c_int8), c_int32)
        ...
        read_timestamps = tdc_base_dll.TDC_readTimestamps
        read_timestamps.restype = c_int
        # TODO: enum
        read_timestamps.argtypes = (c_char_p, c_int)
        ...
        set_channel_delays = tdc_base_dll.TDC_setChannelDelays
        set_channel_delays.restype = c_int
        set_channel_delays.argtypes = (POINTER(c_int32),)
        ...
        set_coincidence_window = tdc_base_dll.TDC_setCoincidenceWindow
        set_coincidence_window.restype = None
        set_coincidence_window.argtypes = ()
        ...
        set_exposure_time = tdc_base_dll.TDC_setExposureTime
        set_exposure_time.restype = c_int
        set_exposure_time.argtypes = (c_int32,)
        ...
        set_timestamp_buffer_size = tdc_base_dll.TDC_setTimestampBufferSize
        set_timestamp_buffer_size.restype = c_int32
        set_timestamp_buffer_size.argtypes = (c_int32,)
        ...
        switch_termination = tdc_base_dll.TDC_switchTermination
        switch_termination.restype = c_int
        switch_termination.argtypes = (c_int32,)
        ...
        write_timestamps = tdc_base_dll.TDC_writeTimestamps
        write_timestamps.restype = c_int
        # TODO: enum
        write_timestamps.argtypes = (c_char_p, c_int)

    else:
        # DLL not available — create stub methods that log and return defaults
        _log.warning("tdcbase.dll not found — TdcBaseDll running in stub/development mode")
        get_timebase = _make_stub("get_timebase", default_return=1e-12)
        init = _make_stub("init")
        de_initialise = _make_stub("de_initialise", default_return=None)
        get_device_params = _make_stub("get_device_params")
        check_for_hbt_feature = _make_stub("check_for_hbt_feature")
        check_for_lifetime_feature = _make_stub("check_for_lifetime_feature")
        configure_apd_cooling = _make_stub("configure_apd_cooling")
        configure_internal_apds = _make_stub("configure_internal_apds")
        configure_self_test = _make_stub("configure_self_test")
        configure_signal_conditioning = _make_stub("configure_signal_conditioning")
        configure_sync_divider = _make_stub("configure_sync_divider")
        enable_channels = _make_stub("enable_channels")
        enable_tdc_input = _make_stub("enable_tdc_input")
        freeze_buffers = _make_stub("freeze_buffers")
        generate_timestamps = _make_stub("generate_timestamps")
        get_channel_delays = _make_stub("get_channel_delays")
        get_coincidence_counters = _make_stub("get_coincidence_counters", default_return=None)
        check_data_loss = _make_stub("check_data_loss")
        get_dev_type = _make_stub("get_dev_type")
        get_last_timestamps = _make_stub("get_last_timestamps", default_return=None)
        get_signal_conditioning = _make_stub("get_signal_conditioning")
        get_sync_divider = _make_stub("get_sync_divider")
        get_timestamp_buffer_size = _make_stub("get_timestamp_buffer_size")
        get_version = _make_stub("get_version", default_return=0.0)
        input_timestamps = _make_stub("input_timestamps")
        perror = _make_stub("perror", default_return=b"stub: no error")
        read_timestamps = _make_stub("read_timestamps")
        set_channel_delays = _make_stub("set_channel_delays")
        set_coincidence_window = _make_stub("set_coincidence_window", default_return=None)
        set_exposure_time = _make_stub("set_exposure_time")
        set_timestamp_buffer_size = _make_stub("set_timestamp_buffer_size")
        switch_termination = _make_stub("switch_termination")
        write_timestamps = _make_stub("write_timestamps")
