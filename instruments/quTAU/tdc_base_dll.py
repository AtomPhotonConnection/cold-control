...
class TdcBaseDll:
    ...
    tdc_base_dll = windll.LoadLibrary(str(Path(base_path) / r"quTAU\userlib\lib64\tdcbase.dll"))
    ...
    get_last_timestamps.argtypes = (c_int32, POINTER(c_int64), POINTER(c_int8), POINTER(c_int32))
    ...
    get_channel_delays = tdc_base_dll.TDC_setChannelDelays
    get_channel_delays.restype = c_int
    get_channel_delays.argtypes = (POINTER(c_int32),)
    ...
    get_coincidence_window = tdc_base_dll.TDC_setCoincidenceWindow
    get_coincidence_window.restype = None
    get_coincidence_window.argtypes = ()
