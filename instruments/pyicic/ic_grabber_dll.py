...
from ctypes import POINTER, c_char, c_char_p, c_float, c_int, c_long, c_void_p, windll
...
class ICGrabberDLL:
    ...
    base_path = Path(
        "C:\\Users\\LabUser\\Documents\\cold-control\\dlls\\The Imaging Source Europe GmbH\\TIS Grabber DLL"
    )
    windll.LoadLibrary(str(base_path / "bin" / "x64" / "TIS_DShowLib10_x64.dll"))
    windll.LoadLibrary(str(base_path / "bin" / "x64" / "TIS_UDSHL10_x64.dll"))
    _ic_grabber_dll = windll.LoadLibrary(str(base_path / "bin" / "x64" / "tisgrabber_x64.dll"))
    ...
    open_device.argtypes = (GrabberHandlePtr, c_char_p)
    ...
    set_video_format.argtypes = (GrabberHandlePtr, c_char_p)
    ...
    set_video_norm.restype = c_int
    set_video_norm.argtypes = (GrabberHandlePtr, c_char_p)
    ...
    start_live.argtypes = (GrabberHandlePtr, c_int)
    ...
    prepare_live.argtypes = (GrabberHandlePtr, c_int)
    ...
    is_camera_property_available.argtypes = (GrabberHandlePtr, c_int)
    ...
    set_camera_property.argtypes = (GrabberHandlePtr, c_int, c_long)
    ...
    camera_property_get_range.argtypes = (GrabberHandlePtr, c_int, POINTER(c_long), POINTER(c_long))
    ...
    get_camera_property.argtypes = (GrabberHandlePtr, c_int, POINTER(c_long))
    ...
    enable_auto_camera_property.argtypes = (GrabberHandlePtr, c_int, c_int)
    ...
    is_camera_property_auto_available.argtypes = (GrabberHandlePtr, c_int)
    ...
    get_auto_camera_property.argtypes = (
        GrabberHandlePtr,
        c_int,
        POINTER(c_int),
    )  # EDIT BY TOM: TYPO HERE USED {} INSTEAD OF () --> WAS CAUSING ERRORS
    ...
    is_video_property_available.argtypes = (GrabberHandlePtr, c_int)  # todo
    ...
    video_property_get_range.argtypes = (
        GrabberHandlePtr,
        c_int,  # todo
        POINTER(c_long),
        POINTER(c_long),
    ...
    is_video_property_auto_available.argtypes = (GrabberHandlePtr, c_int)  # todo
    ...
    get_auto_video_property.argtypes = (
        GrabberHandlePtr,
        c_int,  # todo enum
        POINTER(c_int),
    )
    ...
    set_video_property.argtypes = (GrabberHandlePtr, c_int, c_long)  # todo enum
    ...
    enable_auto_video_property.argtypes = (
        GrabberHandlePtr,
        c_int,  # todo enum
        c_int,
    )
    ...
    get_image_description.argtypes = (
        GrabberHandlePtr,
        POINTER(c_long),
        POINTER(c_long),
        POINTER(c_int),
    ...
    snap_image.argtypes = (GrabberHandlePtr, c_int)
    ...
    list_devices.argtypes = (
        POINTER((c_char * 20) * 40),  # hardcoded 40 devices, each with 20 characters
        c_int,
    )
    ...
    list_video_formats.argtypes = (GrabberHandlePtr, POINTER((c_char * 80) * 40), c_int)
    ...
    get_input_channel.argtypes = (GrabberHandlePtr, c_int)
    ...
    get_video_norm.argtypes = (GrabberHandlePtr, c_int)
    ...
    get_video_format.argtypes = (GrabberHandlePtr, c_int)
    ...
    open_device_by_unique_name.argtypes = (GrabberHandlePtr, c_char_p)
    ...
    get_unique_name.argtypes = (GrabberHandlePtr, c_char_p, c_int)
    ...
    enable_trigger.argtypes = (GrabberHandlePtr, c_int)
    ...
    msg_box.argtypes = (c_char_p, c_char_p)
    ...
    set_frame_ready_callback.argtypes = (GrabberHandlePtr, c_void_p, c_void_p)
    ...
    set_continuous_mode.argtypes = (GrabberHandlePtr, c_int)
    ...
    set_trigger_mode.argtypes = (GrabberHandlePtr, c_char_p)
    ...
    set_trigger_polarity.argtypes = (GrabberHandlePtr, c_int)
    ...
    get_exp_reg_val_range.argtypes = (GrabberHandlePtr, POINTER(c_long), POINTER(c_long))
    ...
    get_exp_reg_val.argtypes = (GrabberHandlePtr, POINTER(c_long))
    ...
    set_exp_reg_val.argtypes = (GrabberHandlePtr, c_long)
    ...
    enable_exp_reg_val_auto.argtypes = (GrabberHandlePtr, c_int)
    ...
    get_exp_reg_val_auto.argtypes = (GrabberHandlePtr, POINTER(c_int))
    ...
    get_exp_abs_val_range.argtypes = (GrabberHandlePtr, POINTER(c_float), POINTER(c_float))
    ...
    get_exp_abs_val.argtypes = (GrabberHandlePtr, POINTER(c_float))
    ...
    set_exp_abs_val.argtypes = (GrabberHandlePtr, c_float)
    ...
    get_color_enhancement.argtypes = (GrabberHandlePtr, POINTER(c_int))
    ...
    set_color_enhancement.argtypes = (GrabberHandlePtr, c_int)
    ...
    set_frame_rate.argtypes = (GrabberHandlePtr, c_float)
    ...
    is_property_available.argtypes = (GrabberHandlePtr, c_char_p, c_char_p)
    ...
    get_property_value_range.argtypes = (
        GrabberHandlePtr,
        c_char_p,
        c_char_p,
        POINTER(c_int),
    ...
    get_property_value.argtypes = (GrabberHandlePtr, c_char_p, c_char_p, POINTER(c_int))
    ...
    set_property_value.argtypes = (GrabberHandlePtr, c_char_p, c_char_p, c_int)
    ...
    get_property_absolute_value_range.argtypes = (
        GrabberHandlePtr,
        c_char_p,
        c_char_p,
        POINTER(c_float),
    ...
    get_property_absolute_value.argtypes = (GrabberHandlePtr, c_char_p, c_char_p, POINTER(c_float))
    ...
    set_property_absolute_value.argtypes = (GrabberHandlePtr, c_char_p, c_char_p, c_float)
    ...
    get_property_switch.argtypes = (GrabberHandlePtr, c_char_p, c_char_p, POINTER(c_int))
    ...
    set_property_switch.argtypes = (GrabberHandlePtr, c_char_p, c_char_p, c_int)
