...
stokes_pulse_loc = (
    r"waveforms\pulse_shaping_exp\normalised_pulses\non_optimised\2_stokes_175ns_0.2.csv"
)
pump_pulse_loc = r"waveforms\pulse_shaping_exp\normalised_pulses\non_optimised\1_pump_175ns_20.csv"

RabiClassStokes = RabiFreqVoltageConverter(
    r"waveforms\pulse_shaping_exp\calibrations\jan\STIRAP_DL_PRO\23-06\70MHz\rabi_data_stokes.csv"
)
RabiClassPump = RabiFreqVoltageConverter(
    r"waveforms\pulse_shaping_exp\calibrations\jan\STIRAP_ELYSA\23-06\116MHz\rabi_data_pump.csv"
)
