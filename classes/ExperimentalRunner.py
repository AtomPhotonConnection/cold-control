...
try:
    from instruments.WX218x.WX218x_DLL import (
        ...
        WX218x_SequenceAdvanceMode,
        WX218x_TraceMode,
        WX218x_TriggerImpedance,
        WX218x_TriggerMode,
        WX218x_TriggerSlope,
        WX218x_Waveform,
    )
    ...
    class WX218x_Waveform:
        (SINE, SQUARE, TRIANGLE, RAMP_UP, RAMP_DOWN, DC, SINC, GAUSSIAN, EXPONENTIAL, NOISE) = map(
            _c_int32, range(1, 11)
        )
        ...
        if c.camera_trig_levs == None:
            c.camera_trig_levs = (
                ...
                next(
                    ...
                    for ch in daq_controller.getChannels()
        ...
        for t in c.t_imgs:
            ...
            sequenceCopy.updateChannel(
                ...
                [
                    ...
                    (
                        np.clip(t - c.camera_pulse_width, 0, self.sequence.getLength()),
...
class MotFluoresceExperiment(GenericExperiment):
    ...
    def __init__(
        ...
        if sequence is not None:
            Warning(
                "The sequence should be provided as part of the mot_fluoresce_configuration object. Providing it separately is deprecated and may be removed in future versions."
            )
    ...
    def _update_daq_channel_static_values(self, channel_number, new_val):
        ...
        try:
            channel: DAQ_channel = next(
                ch for ch in self.daq_controller.getChannels() if ch.chNum == channel_number
            )
